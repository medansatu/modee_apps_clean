  ...
  Widget get view => Scaffold(
    ...
    appBar: AppBar(
        leading: Padding(
          ...
          child: SvgPicture.asset("lib/app/presentation/assets/images/logoonly.svg"),
        ),
          ...
          SizedBox(
            ...
            child: GridView.builder(
              ...
              itemBuilder: ((context, index) {
                final prod_reversed = controller.products.reversed.toList()[index];                
                return NewArrivalItem(
                    id: prod_reversed.id,
                    imageUrl: prod_reversed.imageUrl,
                    price: prod_reversed.price,
                    route: () => controller.navigateToProductDetail(prod_reversed),
                  );
              }),
            ),
          ),
            ...
            child: GridView.builder(
              ...
              itemBuilder: ((context, index) {                
                ...
                return CategoryItem(
                    ...
                    route: () => controller.navigateToCategoryItems(product, category),
                  );
              }),
              gridDelegate:
